...
.controller('ContactsCtrl', ['$scope', '$firebaseArray', function($scope, $firebaseArray) {
  var ref = new Firebase('https://mycontacts-application1.firebaseio.com/contacts');
  ...
  $scope.updateForm = function(){
    ...
    record.address[0].zip_code = $scope.zip_code || null;

    $scope.contacts.$save(record).then(function(ref){
      console.log("Record Updated with key");
    });
